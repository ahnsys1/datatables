...
public final class PasswordVaultApp {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            Path vaultPath = Path.of(System.getProperty("user.home"), ".password-manager2", "vault.dat");
    ...
    private static void validateNewPassword(char[] password, char[] confirmation) {
        if (password.length < 16) {
            throw new IllegalArgumentException("Hlavní heslo musí mít alespoň 16 znaků.");
        }
